...
//Audio errors
#define API_ERROR_AUDIO_NOT_CONNECTED        LSHelpers::ErrorResponse(200, "Audio not connected")
#define API_ERROR_INVALID_SPKTYPE(name)      LSHelpers::ErrorResponse(201, "tvSoundOutput %s not implemented", name)
#define API_ERROR_VOLUME_LIMIT(msg)          LSHelpers::ErrorResponse(202, msg)
